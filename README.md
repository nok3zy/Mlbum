...
## Method - Usecase
> 1. 유저마다 아이디를 부여하고 해당 아이디에 그룹에 접근할 수 있는 권한을 부여한다.
> 2. 유저가 그룹을 만들면 해당 유저에게 그룹원을 초대할 수 있는 권한을 준다.
> 3. 앨범의 표현은 바둑판, 폴리곤 형식이 있다.
> 4. 앨범의 사진을 하나 클릭하면 모달창처럼 올라온다. 그리고 클릭을 하면 비트화도 할 수 있다?
